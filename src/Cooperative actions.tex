...
\subsection{Cooperative Actions}\index{Encounters, Rounds, And Initiative!Cooperative Actions}
...
\caption{Crafting Difficulty and Time}
\label{tab:Crafting Difficulty and Time}
\begin{NiceTabular}{ | Y | Y[3] | Y | }[hlines]
\hline
\textbf{Difficulty} & \textbf{Craft} & \textbf{General Time to Build} \\ \hline
0 & Something extremely simply, like tying a rope or finding an appropriately sized rock & a few minutes at most \\ \hline
1 & Torch & Five minutes \\ \hline
2 & Spear, simple shelter, piece of furniture & One hour \\ \hline
3 & Bow, door, basic article of clothing & One day \\ \hline
4 & Sword, chainmail vest & One to two days \\ \hline
5 & Common technological item (electric light), nice piece of lewellery or an art object & One week \\ \hline
6 & Technological item (watch, transmitter), really nice piece of jewellery or art object, elegant craftwork & One month \\ \hline
7 & Technological item (computer), major work of art & One year \\ \hline
8 & Technological item (something from beyond Earth) & Many years \\ \hline
9 & Technological item (something from beyond Earth) & Many years \\ \hline
10 & Technological item (something from beyond Earth) & Many years \\ \hline
...
\subsection{Guarding}\index{Encounters, Rounds, And Initiative!Guarding}
...
\subsection{Healing}\index{Encounters, Rounds, And Initiative!Healing}
...
\subsection{Interacting with Creatures}\index{Encounters, Rounds, And Initiative!Interacting with Creatures}
...
\subsection{Jumping}\index{Encounters, Rounds, And Initiative!Jumping}
...
\subsection{Looking or Listening}\index{Encounters, Rounds, And Initiative!Looking or Listening}
...
\subsection{Moving a Heavy Object}\index{Encounters, Rounds, And Initiative!Moving a heavy object}
...
\subsection{Operating or Disabling a Device, or Picking a Lock}\index{Encounters, Rounds, And Initiative!Operating or Disabling a Device, or Picking a Lock}
...
\subsection{Riding or Piloting}\index{Encounters, Rounds, And Initiative!Riding or Piloting}
...
\caption{Riding or Piloting Difficulty}
\label{tab:Riding or Piloting Difficulty}

\begin{tabularx}{0.5\textwidth}{ | Y | Y | }
\hline
\textbf{Difficulty} & \textbf{Maneuver} \\ \hline
0 & Riding \\ \hline
1 & Staying on the mount (including a motorcycle or similar vehicle) in a battle or other difficult situation \\ \hline
3 & Staying on a mount (including a motorcycle or similar vehicle) when you taka damage \\ \hline
4 & Mounting a moving steed \\ \hline
4 & Making an abrupt turn with a vehicle while moving fast \\ \hline
4 & Getting a vehicle to move twice as fast as normal for one round \\ \hline
5 & Coaxing a mount to move or jump twice as fast or far as normal for one round \\ \hline
5 & Making a long jump with a vehicle not intended to go airborne (like a car) and remaining in control \\ \hline
...
\subsection{Sneaking}\index{Encounters, Rounds, And Initiative!Sneaking}
...
\subsection{Swimming}\index{Encounters, Rounds, And Initiative!Swimming}
...
\subsection{Understanding, Identifying, or Remembering}\index{Encounters, Rounds, And Initiative!Understanding, Identifying, or Remembering}
...
\caption{Knowledge Difficulty}
\label{tab:Knowledge Difficulty}

\begin{tabularx}{0.5\textwidth}{ | Y | Y | }
\hline
\textbf{Difficulty} & \textbf{Knowledge} \\ \hline
0 & Common knowledge \\ \hline
1 & Simple knowledge \\ \hline
3 & Something a scholar probably knows \\ \hline
5 & Something even a scholar might not know \\ \hline
7 & Knowledge very few people possess \\ \hline
10 & Completely lost knowledge \\ \hline
...
\section{Vehicular Movement}\index{Vehicles!Vehicular Movement}
...
\section{Vehicular Combat}\index{Vehicles!Vehicular Combat}
...
\caption{Vehicle fight}
\label{tab:Vehicle fight}

\begin{tabularx}{\textwidth}{ | Y | Y | Y | }
\hline
\textbf{Targeting Task} & \textbf{Attack Hindered} & \textbf{Effect} \\ \hline
Disable weapons & Two steps & One or more of the vehicle weapon's no longer function \\ \hline
Disable defences (if applicable) & Two steps & Attacks against the vehicles are eased \\ \hline
Disable engine/drive & Three steps & Vehicle cannot move, or movement is hampered \\ \hline
Disable maneuverability & Two steps & Vehicle cannot alter it's present course \\ \hline
Strike power core or vital spot & Five steps & Vehicle is completely destroyed \\ \hline
