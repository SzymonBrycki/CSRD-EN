...
\section{Choosing Foci}\index{Focus!Choosing Foci}
...
\section{Focus Connections}\index{Focus!Focus Connections}
...
\begin{enumerate}
\item Pick one other PC. For reasons unknown to you, that character is completely immune to your focus abilities, whether you use them for help or for harm.
\item Pick one other PC. You knew of that character years ago, but you don’t think they knew you.
\item Pick one other PC. You’re always trying to impress them, but you’re not sure why. 
\item Pick one other PC. That character has a habit that annoys you, but you’re otherwise quite impressed with their abilities.
\item Pick one other PC. That character shows potential in appreciating your particular paradigm, fighting style, or other
...
\item Pick one other PC. If they are within immediate range when you’re in a fight, sometimes they provide an asset, and sometimes they accidentally hinder your attack rolls (50\% chance either way, determined per fight).
\item Pick one other PC. You once saved their life, and they clearly feel indebted to you. You wish they didn’t; it’s just part of the job.
\item Pick one other PC. That character recently mocked you in some fashion that really hurt your feelings. How you deal with this (if at all) is up to you.
\item Pick one other PC. That character knows you have suffered at the hands of robotic entities in the past. Whether you hate robots now is up to you, which may affect your relationship with the character if they are friendly with robots or have robotic parts.
\item Pick one other PC. That character comes from the same place you do, and you knew each other as children.
\item Pick one other PC. In the past, they taught you a few tricks to use in a fight.
\item Pick one other PC. That character doesn’t seem to approve of your methods.
\item Pick one other PC. Long ago, the two of you were on opposite sides of a fight. You won, though you “cheated” in their eyes (but from your perspective, all’s fair in a fight). They may be ready for a rematch, though that’s up to them.
\item Pick one other PC. You are always trying to impress that character with your skill, wit, appearance, or bravado. Perhaps they are a rival, perhaps you need their respect, or perhaps you’re romantically interested in them.
\item Pick one other PC. You fear that character is jealous of your abilities and worry that it might lead to problems.
\item Pick one other PC. You accidentally caught them in a trap you set, and they had to get free on their own.
\item Pick one other PC. You were once hired to track down someone who was close to that character.
\item Pick two PCs (preferably ones who are likely to get in the way of your attacks). When you miss with an attack and the GM rules that you struck someone other than your target, you hit one of these two characters.
\item Pick one other PC. You’re not sure how or from where, but that character has a line on bottles of rare alcohol and can get them for you for half price.
\item Pick one other PC. You recently had a possession go missing, and you’re becoming convinced that they took it. Whether or not they did is up to them.
\item Pick one other PC. They always seem to know where you are, or at least in what direction you are in relation to them.
\item Pick one other PC. Seeing you use your focus abilities seems to trigger an unpleasant memory in that character. That memory is up to the other PC, although they may not be able to consciously recall it.
\item Pick one other PC. Something about them interferes with your abilities. When they stand next to you, your focus abilities cost 1 additional point.
\item Pick one other PC. Something about them complements your abilities. When they stand next to you, the first focus ability you use in any 24-hour period costs 2 fewer points.
\item Pick one other PC. You have known that character for a while, and they helped you gain control of your focus-related abilities.
\item Pick one other PC. Sometime in that character’s past, they had a devastating experience while attempting something that you do as a matter of course thanks to your focus. Whether they choose to tell you about it is up to them.
\item Pick one other PC. Their occasional clumsiness and loud behavior irritate you.
\item Pick one other PC. In the recent past, while practicing, you accidentally hit them with an attack, wounding them badly. It is up to them to decide whether they resent or forgive you.
\item Pick one other PC. They owe you a significant amount of money.
\item Pick one other PC. In the recent past, while escaping a threat, you accidentally left that character to fend for themselves. They survived, but just barely. It is up to the player of that character to decide whether they resent you or have decided to forgive you.
\item Pick one other PC. Recently, they accidentally (or perhaps intentionally) put you in a position of danger. You’re fine now, but you’re wary around them.
\item Pick one other PC. From your perspective, they seem nervous around a specific idea, person, or situation. You would like to teach them how to be more comfortable with their fears (if they will let you).
\item Pick one other PC. They called you a coward once.
\item Pick one other PC. That character always recognizes you or your handiwork, whether you’re in disguise or are long gone when they arrive on the scene. 
\item Pick one other PC. You inadvertently caused an accident that put them into a sleep so deep they didn’t wake for three days. Whether they forgive you or not is up to them.
\item Pick one other PC. You are pretty sure you are related in some fashion.
\item m Pick one other PC. You accidentally learned something they were trying to keep a secret.
\item Pick one other PC. They are especially sensitive to the use of your flashier focus abilities, and occasionally they become dazzled for a few rounds, which hinders their actions.
\item Pick one other PC. They appear to have a treasured item that was once yours, but that you lost in a game of chance years ago.
\item Pick one other PC. If it wasn’t for you, that character would have failed a past test of mental achievement.
\item Pick one other PC. Based on a couple of comments you’ve overheard, you suspect that they don’t hold your area of training or favorite hobby in the highest regard.
\item Pick one other PC whose focus intertwines with yours. This odd connection affects them in some way. For example, if the character uses a weapon, your focus ability sometimes improves their attack in some fashion.
\item Pick one other PC. They are deathly afraid of heights. You would like to teach them how to be more comfortable with their feet off the ground. They must decide whether or not to take you up on your offer.
\item Pick one other PC. They are skeptical of your claims about something momentous that happened in your past. They might even attempt to discredit you or discover the “secret” behind your story, though that’s up to them.
\item Pick one other PC. They have a knack for being able to recognize where your plans or schemes have a weak spot.
\item Pick one other PC. That character’s face is so intriguing to you in a way you don’t understand that you sometimes find yourself sketching their likeness in the dirt or using some other medium you have access to.
\item Pick one other PC. That character has an extra item of regular equipment you gave them, either something you made or an item you just wanted to give them. (They choose the item.)
\item Pick one other PC. They commissioned you to do a job for them. You’ve already been paid but haven’t yet completed the job.
\item Pick one other PC. You worked together in the past, and the job ended badly.
\item Pick one other PC. While they stand next to you and use their action to concentrate on helping you, one of your focus ability’s ranges is doubled. 
\end{enumerate}

\section{Story Behind the Focus}\index{Focus!Story Behind the Focus}
...
\subsection{Abides in Stone}\index{Focus!Foci!Abides in Stone}
...
\subsection{Absorbs Energy}\index{Focus!Foci!Absorbs Energy}
...
\subsection{Awakens Dreams}\index{Focus!Foci!Awakens Dreams}
...
\subsection{Battles Robots}\index{Focus!Foci!Battles Robots}
...
\subsection{Bears a Halo of Fire}\index{Focus!Foci!Bears a Halo of Fire}
...
\subsection{Blazes With Radiance}\index{Focus!Foci!Blazes with Radiance}
...
\subsection{Brandishes an Exotic Shield}\index{Focus!Foci!Brandishes an Exotic Shield}
...
\subsection{Builds Robots}\index{Focus!Foci!Builds Robots}
...
\subsection{Calculates the Incalculable}\index{Focus!Foci!Calculates the Incalculable}
...
\subsection{Channels Divine Blessings}\index{Focus!Foci!Channels Divine Blessings}
...
\subsection{Commands Mental Powers}\index{Focus!Foci!Commands Mental Powers}
...
\subsection{Conducts Weird Science}\index{Focus!Foci!Conducts Weirds Science}
...
\subsection{Consorts with the Dead}\index{Focus!Foci!Consorts with the Dead}
...
\subsection{Controls Beasts}\index{Focus!Foci!Controls Beasts}
...
\subsection{Controls Gravity}\index{Focus!Foci!Controls Gravity}
...
\subsection{Copies Superpowers}\index{Focus!Foci!Copies Superpowers}
...
\subsection{Crafts Illusions}\index{Focus!Foci!Crafts illusions}
...
\subsection{Crafts Unique Objects}\index{Focus!Foci!Crafts Unique Objects}
...
\subsection{Dances with Dark Matter}\index{Focus!Foci!Dances with Dark Matter}
...
\subsection{Defends the Gate}\index{Focus!Foci!Defends The Gate}
...
\subsection{Defends the Weak}\index{Focus!Foci!Defends the Weak}
...
\subsection{Descends From Nobility}\index{Focus!Foci!Descends From Nobility}
...
\subsection{Doesn’t Do Much}\index{Focus!Foci!Doesn't Do Much}
...
\subsection{Drives Like A Maniac}\index{Focus!Foci!Drives Like A Maniac}
...
\subsection{Emerged From the Obelisk}\index{Focus!Foci!Emerged From the Obelisk}
...
\subsection{Employs Magnetism}\index{Focus!Foci!Employs Magnetism}
...
\subsection{Entertains}\index{Focus!Foci!Entertains}
...
\subsection{Exists in Two Places at Once}\index{Focus!Foci!Exists in Two Places at Once}
...
\subsection{Exists Partially Out of Phase}\index{Focus!Foci!Exists Partially Out of Phase}
...
\subsection{Explores Dark Places}\index{Focus!Foci!Explorer Dark Places}
...
\subsection{Fights Dirty}\index{Focus!Foci!Fights Dirty}
...
\subsection{Fights With Panache}\index{Focus!Foci!Fights With Panache}
...
\subsection{Flies Faster Than a Bullet}\index{Focus!Foci!Flies Faster Than a Bullet}
...
\subsection{Focuses Mind Over Matter}\index{Focus!Foci!Focuses Mind Over Matter}
...
\subsection{Fuses Flesh and Steel}\index{Focus!Foci!Fuces Flesh and Steel}
...
\subsection{Fuses Mind and Machine}\index{Focus!Foci!Fuses Mind and Machine}
...
\subsection{Grows to Towering Heights}\index{Focus!Foci!Grows to Towering Heights}
...
\subsection{Has a Thousand Faces}\index{Focus!Foci!Has a Thousand Faces}
...
\subsection{Helps Their Friends}\index{Focus!Foci!Helps Their Friends}
...
\subsection{Howls at the Moon}\index{Focus!Foci!Howls at the Moon}
...
\subsection{Hunts}\index{Focus!Foci!Hunts}
...
\subsection{Ignores Physical Distance}\index{Focus!Foci!Ignores Physical Distance}
...
\subsection{Infiltrates}\index{Focus!Foci!Infiltrates}
...
\subsection{Interprets the Law}\index{Focus!Foci!Interprets the Law}
...
\subsection{Is Idolized by Millions}\index{Focus!Foci!Is Idolized by Millions}
...
\subsection{Is Licensed to Carry}\index{Focus!Foci!Is Licensed to Carry}
...
\subsection{Is Wanted by the Law}\index{Focus!Foci!Is Wanted by the Law}
...
\subsection{Keeps a Magic Ally}\index{Focus!Foci!Keeps a Mgic Ally}
...
\subsection{Leads}\index{Focus!Foci!Leads}
...
\subsection{Learns Quickly}\index{Focus!Foci!Learns Quickly}
...
\subsection{Lives in the Wilderness}\index{Focus!Foci!Lives in the Wilderness}
...
\subsection{Looks for Trouble}\index{Focus!Foci!Looks for Trouble}
...
\subsection{Loves the Void}\index{Focus!Foci!Loves The Void}
...
\subsection{Masters Defense}\index{Focus!Foci!Masters Defense}
...
\subsection{Masters Spells}\index{Focus!Foci!Masters Spells}
...
\subsection{Masters the Swarm}\index{Focus!Foci!Masters the Swarm}
...
\subsection{Masters Weaponry}\index{Focus!Foci!Masters Weaponry}
...
\subsection{Metes Out Justice}\index{Focus!Foci!Metes Out Justice}
...
\subsection{Moves Like a Cat}\index{Focus!Foci!Moves Like a Cat}
...
\subsection{Moves Like the Wind}\index{Focus!Foci!Moves Like the Wind}
...
\subsection{Murders}\index{Focus!Foci!Murders}
...
\subsection{Needs No Weapon}\index{Focus!Foci!Needs No Weapon}
...
\subsection{Never Says Die}\index{Focus!Foci!Never Says Die}
...
\subsection{Operates Undercover}\index{Focus!Foci!Operates Undercover}
...
\subsection{Performs Feats of Strength}\index{Focus!Foci!Performs Feats of Strength}
...
\subsection{Pilots Starcraft}\index{Focus!Foci!Pilots Starcraft}
...
\subsection{Plays Too Many Games}\index{Focus!Foci!Plays Too Many Games}
...
\subsection{Rages}\index{Focus!Foci!Rages}
...
\subsection{Rides the Lightning}\index{Focus!Foci!Rides the Lightning}
...
\subsection{Runs Away}\index{Focus!Foci!Runs Away}
...
\subsection{Sailed Beneath the Jolly Roger}\index{Focus!Foci!Sailed Beneath the Jolly Roger}
...
\subsection{Scavenges}\index{Focus!Foci!Scavenges}
...
\subsection{Sculpts Hard Light}\index{Focus!Foci!Sculpts Hard Light}
...
\subsection{Sees Beyond}\index{Focus!Foci!Sees Beyond}
...
\subsection{Separates Mind From Body}\index{Focus!Foci!Separates Mind From Body}
...
\subsection{Shepherds the Community}\index{Focus!Foci!Shepherds the Community}
...
\subsection{Shepherds Spirits}\index{Focus!Foci!Shepherds Spirits}
...
\subsection{Shreds the Walls of the World}\index{Focus!Foci!Shreds the Walls of the World}
...
\subsection{Shrinks to Minute Size}\index{Focus!Foci!Shrinks to Minute Size}
...
\subsection{Siphons Power}\index{Focus!Foci!Siphons Power}
...
\subsection{Slays Monsters}\index{Focus!Foci!Slays Monsters}
...
\subsection{Soars on Amazing Wings}\index{Focus!Foci!Soars on Amazing Wings}
...
\subsection{Solves Mysteries}\index{Focus!Foci!Solves Mysteries}
...
\subsection{Speaks for the Land}\index{Focus!Foci!Speaks for the Land}
...
\subsection{Stands Like a Bastion}\index{Focus!Foci!Stands Like a Bastion}
...
\subsection{Stretches}\index{Focus!Foci!Stretches}
...
\subsection{Takes Animal Shape}\index{Focus!Foci!Takes Animal Shape}
...
\subsection{Talks to Machines}\index{Focus!Foci!Talks to Machines}
...
\subsection{Throws With Deadly Accuracy}\index{Focus!Foci!Throws With Deadly Accuracy}
...
\subsection{Thunders}\index{Focus!Foci!Thunders}
...
T\subsection{Touches The Sky}\index{Focus!Foci!Touches the Sky}
...
\subsection{Travels Through Time}\index{Focus!Foci!Travels Through Time}
...
\subsection{Was Foretold}\index{Focus!Foci!Was Foretold}
...
\subsection{Wears a Sheen of Ice}\index{Focus!Foci!Wears a Shen of Ice}
...
\subsection{Wears Power Armor}\index{Focus!Foci!Wears Power Armor}
...
\subsection{Wields Invisible Force}\index{Focus!Foci!Wields Invisible Force}
...
\subsection{Wields Two Weapons at Once}\index{Focus!Foci!Wields Two Weapons at Once}
...
\subsection{Works for a Living}\index{Focus!Foci!Works for a Living}
...
\subsection{Works Miracles}\index{Focus!Foci!Works Miracles}
...
\subsection{Works the Back Alleys}\index{Focus!Foci!Works the Back Alleys}
...
\subsection{Works the System}\index{Focus!Foci!Works the System}
...
\subsection{Would Rather Be Reading}\index{Focus!Foci!Would Rather Be Reading}
...
\subsection{Uses Wild Magic}\index{Focus!Foci!Uses Wild Magic}
...
\subsection{Walks the Wild Woods}\index{Focus!Foci!Walks the Wild Woods}
...
GM Intrusions: A wooden character catches fire. A wild swing from a treebranch hits or trips an ally. Some trees have evil hearts and hate all walking things.

\subsection{Wields an Enchanted Weapon}\index{Focus!Foci!Wields an Enchanted Weapon}
...
\section{Creating New Foci}\index{Focus!Creating New Foci}
...
\subsection{Focus Categories}\index{Focus!Creating New Foci!Focus Categories}
...
\item Energy manipulation 

\item Environment manipulation 
...
\subsection{Choosing Abilities By Relative Power}\index{Focus!Creating New Foci!Choosing Abilities By Relative Power}
...
\subsection{Balancing Activities}\index{Focus!Creating New Foci!Balancing Activities}
...
\subsection{Ability Guidelines are not Prescriptive}\index{Focus!Creating New Foci!Ability Guidelines are not Prescriptive}
...
\subsection{Ability Swap}\index{Focus!Creating New Foci!Ability Swap}
...
\subsection{Concept and Category}\index{Focus!Creating New Foci!Concept and Category}
...
\subsection{Abilities That Reference Other Abilities}\index{Focus!Creating New Foci!Abilities That Reference Other Abilities}
...
\subsection{Creating Brand-New Abilities}\index{Focus!Creating New Foci!Creating Brand-New Abilities}
...
\subsection{Choose GM Intrusions}\index{Focus!Creating New Foci!Choose GM Intrusions}
...
\subsubsection{Ally Use}\index{Focus!Creating New Foci!Focus Categories!Ally Use}
...
\textbf{Connection}: Choose four relevant connections from the Focus Connections list. 

\textbf{Additional Equipment}: Any object necessary for the character to keep an ally. For instance, someone with a focus that uses super-science to create robot allies would require tools to build and repair those allies. Some foci in this category don’t require anything to gain or retain their benefits.

\textbf{Minor Effect Suggestions}: The NPC ally’s tasks are eased on its next turn.

\textbf{Major Effect Suggestions}: The NPC ally gains an immediate extra action.
...
\textbf{Ability Selection Guidelines}

\textbf{Tier 1}: Choose a low-tier ability that grants a level 2 NPC follower to the character, or gives a similar benefit provided by an NPC. Alternatively, lay the groundwork for gaining such NPC allies at higher tiers by choosing an ability that gives the character influence over others.
...
\textbf{Tier 2}: Choose a low-tier ability that grants influence over similar kinds of NPCs as the follower gained at the previous tier. If no follower was gained at the previous tier, this ability should provide that benefit now. 
...
\textbf{Tier 3}: Choose two mid-tier abilities. Give both of them as options for the focus; a PC will choose one or the other.
...
\textbf{Tier 4}: Choose a mid-tier ability that gives the character an offensive or defensive capability if they haven’t previously gained one, preferably within the theme of the focus. For instance, if the character gains followers because of their charisma, this ability might let them command foes for brief periods. If the character gains followers by building or calling them, this ability might let them affect entities of the same type that are not already their followers.
...
\textbf{Tier 5}: Choose an ability that improves the character by providing a defense, an improved stat Pool, or another kind of protection.
...
\textbf{Tier 6}: Choose two high-tier abilities. Give both of them as options for the focus; a PC will choose one or the other.
...
\subsubsection{Basic}\index{Focus!Creating New Foci!Focus Categories!Basic}
...
\textbf{Additional Equipment}: Any object necessary to fulfill the overarching theme of the focus. For instance, a focus called Would Rather Be Reading should grant a handful of books to the character. A focus called Works for a Living should provide a set of tools.

\textbf{Minor Effect Suggestions}: Next action is eased.

\textbf{Major Effect Suggestions}: Make a free, no-action recovery roll that doesn’t count against daily recovery rolls.

The following are examples and not meant to provide a complete list of all possible foci in this category.

\begin{itemize}
\item Doesn’t Do Much
\item Interprets the Law
\item Learns Quickly
...
\textbf{Tier 1}: Choose an ability that grants training or an asset to skills associated with the focus’s theme, or that grants 5 or 6 points to a particular Pool. 
...
\textbf{Tier 2}: Choose whichever kind of ability wasn’t chosen at tier 1. 
...
\textbf{Tier 5}: Choose an ability that allows the character to branch out slightly—perhaps one like Expert Skill that allows them to automatically succeed on a task they’re trained in.
...
\subsubsection{Energy Manipulation}\index{Focus!Creating New Foci!Focus Categories!Energy Manipulation}
...
\textbf{Additional Equipment}: One or more pieces of equipment immune to the energy manipulated, which might be a set of clothes. Alternatively, something related to the energy being generated. Some foci in this category don’t require additional equipment.

\textbf{Energy Abilities}: If a character type grants special abilities that normally use some other kind of energy, they now produce the kind used by this focus. For example, if a character uses this focus to manipulate electricity, their force blasts become blasts of electricity. These alterations change nothing except the type of damage and any knock-on effects (for instance, electricity might temporarily short out electronic systems). 

\textbf{Minor Effect Suggestions}: The target or something near the target is hindered because of residual energy.

\textbf{Major Effect Suggestions}: An important item on the target’s person is destroyed.
...
\item Thunders
\item Wears a Sheen of Ice
\end{itemize}

\textbf{Ability Selection Guidelines}

\textbf{Tier 1}: Choose a low-tier ability that either inflicts damage or provides protection using the appropriate energy type in some fashion.
...
\textbf{Tier 4}: Choose whichever kind of ability wasn’t chosen at tier 3. 

\textbf{Tier 5}: Choose a high-tier ability that inflicts damage (and possibly a related effect) that can affect more than one target using the appropriate energy type, or an ability that uses the energy in some fashion not previously used, as described in tiers 3 and 6.
...
\subsubsection{Environment Manipulation}\index{Focus!Creating New Foci!Focus Categories!Environment Manipulation}
...
\textbf{Additional Equipment}: Any object necessary to manipulate the surrounding environment. For instance, someone with a focus that grants the ability to craft objects would require basic tools. Some foci in this category don’t require anything to gain or retain their benefits.
...
\textbf{Minor Effect Suggestions}: The target gets turned around, and its next attack is hindered.

\textbf{Major Effect Suggestions}: The character is refreshed and recovers 4 points to one Pool.
...
\item Calculates the Incalculable
...
\textbf{Tier 2}: Choose a low-tier ability that provides a new defensive or offensive capability related to the focus’s theme. 
...
\subsubsection{Exploration}\index{Focus!Creating New Foci!Focus Categories!Exploration}
...
\textbf{Additional Equipment}: Any object necessary to explore. For instance, starting maps and/or
...
\textbf{Minor Effect Suggestions}: You have an asset on any action that involves using your senses, such as perceiving or attacking, until the end of the next round.

\textbf{Major Effect Suggestions}: Your Intellect Edge increases by 1 until the end of the next round.
...
\item Infiltrates
\item Operates Undercover
\item Pilots Starcraft
\item Sees Beyond
\item Separates Mind From Body
\end{itemize}

\textbf{Ability Selection Guidelines}

\textbf{Tier 1}: Choose a low-tier ability that grants the character basic exploratory, survival, or information-gathering capabilities within the focus’s theme.
...
\textbf{Tier 2}: Choose another low-tier ability that grants an additional capability related to exploration, survival, or information gathering.
...
\textbf{Tier 4}: Choose a mid-tier offensive or defensive ability (whichever wasn’t offered at tier 3) that benefits the character. Alternatively, if offensive and defensive abilities are already well represented, choose a different mid-tier ability that broadens the character’s ability to explore, survive, or gather information.

\textbf{Tier 5}: Choose a high-tier ability that alleviates some of the penalties for exploring, surviving, or gathering information in a normally inhospitable place.
...
\subsubsection{Influence}\index{Focus!Creating New Foci!Focus Categories!Influence}
...
\textbf{Additional Equipment}: Any object necessary to achieve the influence suggested should be granted as additional equipment. Some influence foci don’t require anything to gain or retain their benefits.

\textbf{Minor Effect Suggestions}: The range or duration of the influencing ability is doubled. 

\textbf{Major Effect Suggestions}: An ally or indicated target can take an additional action.
...
\item Fuses Mind and Machine
\item Is Idolized by Millions
\item Solves Mysteries
\item Talks to Machines
\item Works the System
\end{itemize}
...
\textbf{Tier 4}: Choose a mid-tier ability that is either an offensive or a defensive use of the influence ability, whichever one wasn’t chosen as an option in the previous tier.

Alternatively, this ability could grant an additional capability related to the kind of influence the focus provides.

\textbf{Tier 5}: Choose a high-tier penultimate use of the specific influence ability granted at lower tiers. 
...
\subsubsection{Irregular}\index{Focus!Creating New Foci!Focus Categories!Irregular}
...
\textbf{Additional Equipment}: Any object necessary to the focus’s theme. For instance, a superhero-themed focus might grant a superhero costume.

\textbf{Minor Effect Suggestions}: The target is also dazed for one round, during which time all of its tasks are hindered.

\textbf{Major Effect Suggestions}: The target is stunned and loses its next turn.
...
\item Flies Faster Than a Bullet
\item Masters Spells
...
\textbf{Tier 1}: Choose a low-tier ability that grants one of the benefits the focus theme promises, one that a first-tier character should have.
...
\textbf{Tier 2}: Choose a low-tier ability that grants one of the benefits the focus theme promises, one that’s presumably not immediately related to the one provided at tier 1. That said, if a defense wasn’t provided at tier 1, tier 2 is a good place to add it.
...
\textbf{Tier 4}: Choose a mid-tier ability that grants one of the benefits the focus theme promises, one that may not be immediately related to those provided at earlier tiers. 

\textbf{Tier 5}: Choose a high-tier ability that grants one of the benefits the focus theme promises, one that may not be immediately related to those provided at earlier tiers.
...
\subsubsection{Movement Exercise}\index{Focus!Creating New Foci!Focus Categories!Movement Exercise}
...
\item Works the Back Alleys
\end{itemize}

\textbf{Ability Selection Guidelines}

\textbf{Tier 1}: Choose a low-tier ability that grants the basic benefit of the specific movement style, whether that’s enhanced speed, agility, immateriality, and so on.
...
\textbf{Tier 2}: Choose a low-tier ability that provides a new offensive or defensive capability related to the focus’s theme. 
...
\textbf{Tier 4}: Choose a mid-tier ability that further enhances the advantages provided by focus’s movement-enhancing paradigm. This could provide a new or better form of defense (directly, or indirectly if moving to a location or time where danger doesn’t threaten), or a new or better form of offense.
...
\subsubsection{Striker Combat}\index{Focus!Creating New Foci!Focus Categories!Striker Combat}
...
\textbf{Additional Equipment}: The weapon, tool, or other special item or substance (if any) required to engage in the particular style of combat. For instance, a dose of level 5 poison for Fights Dirty or Murders, a trophy from a previously defeated foe for Battles Robots, or stylish clothes for Fights With Panache.

\textbf{Minor Effect Suggestions}: The target is so dazzled by your expertise that it is dazed for one round, hindering all of its tasks.

\textbf{Major Effect Suggestions}: Make an immediate additional attack using an attack provided by the focus as part of your turn.
...
\textbf{Tier 1}: Choose a low-tier ability that inflicts additional damage when a character attacks using the focus’s particular fighting style, energy, or attitude, or when used against a chosen enemy.
...
\textbf{Tier 4}: Choose a mid-tier ability that further enhances the advantages provided by the focus’s paradigm. Often, this includes training in a particular kind of attack. Alternatively, the ability might increase the advantages provided by achieving a certain combat status, such as gaining surprise.

\textbf{Tier 5}: Choose a high-tier ability that inflicts damage. Alternatively, if focused on fighting a particular kind of foe, this ability might give the character a chance to completely neutralize, destroy, blind, or kill a singular target of up to level 3 (or higher, if the focus is on a singular foe).
...
\subsubsection{Support}\index{Focus!Creating New Foci!Focus Categories!Support}
...
\textbf{Additional Equipment}: Any object necessary to provide support. For instance, someone with a focus that uses entertainment to help others would require an instrument or similar object in aid of their craft. Some foci in this category don’t require anything to gain or retain their benefits.

\textbf{Minor Effect Suggestions}: You can draw an attack without having to use an action at any point before the end of the next round.

\textbf{Major Effect Suggestions}: You can take an extra action in aid of an ally.
...
\textbf{Tier 4}: Choose a mid-tier ability that gives an ally a direct boon or provides the character with a way to help another. It could also be an ability that harms or nullifies a foe, as removing foes certainly helps allies.
...
\subsubsection{Tank Combat}\index{Focus!Creating New Foci!Focus Categories!Tank Combat}
...
\textbf{Additional Equipment}: Any object necessary to maintain a physical transformation (such as a tool for repair if partly robotic, a shield or other defensive tool used if skilled, or possibly some kind of amulet or serum). Some tank combat foci don’t require anything to gain or retain their benefits.

\textbf{Minor Effect Suggestions}: +2 to Armor for a few rounds.

\textbf{Major Effect Suggestions}: Regain 2 points to Might Pool.
...
\textbf{Tier 2}: If the theme of the focus isn’t physical transformation, choose a low-tier ability that provides an additional method of defending, healing damage, or avoiding attacks. 
...
\section{Customizing Foci}\index{Focus!Customizing Foci}
