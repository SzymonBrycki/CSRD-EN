...
o	Stunned: Target takes no action. 
o	Confess: Target starts with their most egregious crimes/secrets, one per turn. 
o	Betray: Target attacks nearby allies. 
o	Forget: Target goes back to whatever they were doing and doesn’t remember meeting the inkubus unless or until they meet again. 
...
o	Soul of damned previous target possesses the new target once per day for one minute on a failed Intellect defense roll. Possessing spirit may work against target, or simply take off seeking some goal of their own. 
o	Wound leaks a horrific smell and discharge; target’s pleasant interaction tasks are hindered by two steps. 
o	Target’s GM intrusion range increases by 1 until bullet is removed. 
...
o	Target is frozen in amber until they can escape. 
o	Deathbinder learns one of the target’s secrets. 
o	Target is teleported to a pre-prepared nearby location. 
...
o	Automatically hits target within long range—a targeted PC should get a GM intrusion for this attack. 
o	The soul round deals damage and the character descends two steps on the damage track, or one step on a successful Might defense roll. 
o	Target is cursed on a failed Intellect defense roll. 
