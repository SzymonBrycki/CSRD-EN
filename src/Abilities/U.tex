...
\myability{Ultra Enhancement}: You gain +1 to Armor and +5 to each of your three stat Pools. Enabler. 
 
\myability{Unarmed Fighting Style}: You are trained in unarmed attacks. Enabler.
 
\myability{Unarmored Fighter}: While unarmored, you are trained in Speed defense tasks. Enabler. 
