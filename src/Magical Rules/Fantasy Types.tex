...
\chapter{Fantasy Types}\index{Fantasy types}
...
\begin{table}[H]
\centering
\caption{Fantasy Types}
\label{tab: Fantasy Types}

\begin{tabularx}{\linewidth}{| Y | Y |}
% \begin{tabularx}{\linewidth}{| p{0.5\linewidth} | p{0.5\linewidth} |}
\hline
\textbf{Role} & \textbf{Character Type} \\
\hline
% Tutaj wpisujesz dane do tabeli
Warrior & Warrior \\ \hline
Knight & Warrior\\ \hline
Ranger & Explorer  \\ \hline
Barbarian & Explorer flavored with Combat  \\ \hline
Thief & Explorer flavored with stealth  \\ \hline
Wizard & Adept  \\ \hline
Cleric & Speaker flavored with magic  \\ \hline
Druid & Explorer flavored with magic  \\ \hline
Warrior mage & Warrior flavored with magic  \\ \hline
Bard & Speaker  \\ \hline
