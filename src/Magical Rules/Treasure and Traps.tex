...
\chapter{Treasure and Traps}\index{Treasure and Traps}

\section{Awarding Treasure}\index{Treasure and Traps!Awarding Treasure}
...
\section{Dungeons, Castles and Keeps}\index{Treasure and Traps!Dungeons, Castles and Keeps}
...
\textbf{Stone door} (level 5): These heavy doors are usually carved from a solid block of stone and designed to pivot on a center point. They are common in places like dungeons where wood and metal are scarce. Stone doors are vulnerable to piercing weapons (attacks are eased) but resistant to bashing and slashing weapons (attacks are hindered). 

\textbf{Iron door} (level 6): A solid iron door is meant to protect something very valuable or vulnerable, such as a vault or a king’s tomb. In a damp environment like a dungeon, they tend to rust and stick in place. 

\textbf{Wooden portcullis} (level 3): The gaps in a portcullis present more defense opportunities than a door, such as allowing archers to fire at the creatures trapped by it. They’re also useful in closing access to a waterway without impacting its flow. A wooden portcullis is relatively fragile and usually isn’t meant to keep anyone out for long. 

\textbf{Iron portcullis} (level 6): Much sturdier than wood, an iron portcullis is meant to keep creatures in place as long as necessary. Often the best way to get past a portcullis is to lift it instead of breaking it, but some are designed to lock in place to prevent this. A door to a prison cell is essentially a type of iron portcullis.

\section{Traps}\index{Treasure and Traps!Traps}

One common element of fantasy exploration—particularly for castles and dungeons—is the danger of traps.

\subsection{Triggering Traps}
...
\subsection{Disabling, Damaging, and Bypassing Traps}
...
\subsection{Understanding the Listings}
...
\textbf{Level}: Like the difficulty of a task, each trap has a level. You use the level to determine the target number a PC must reach to find, evade, or disable the trap. In each entry, the difficulty number for the trap is listed after its level (always three times the trap’s level). 

\textbf{Description}: This general description explains what the trap does, how it operates, whether it resets automatically, if it has a limited number of uses, and so on.

\textbf{Damage Inflicted}: Generally, when a trap hits a creature, it inflicts its level in damage regardless of the form of attack (arrow, poison, collapsing ceiling, and so on). The entries always specify the amount of damage inflicted, even if it’s the normal amount for a trap of its level. 

\textbf{Modifications}: Use these numbers when a trap’s information says to use a different target number. For example, a level 4 trap might say “defends as level 5,” which means PCs attacking it or trying to disable it must roll a target number of 15 (for difficulty 5) instead of 12 (for difficulty 4). Typical modifiers are to the trap’s attacks, defenses, and stealth (how hard or easy it is to notice the trap). 

\textbf{GM Intrusion}: This entry suggests one or more ways to use GM intrusions in an encounter with the trap. It’s just one possible idea of many, and the GM is encouraged to come up with their own uses of the game mechanic.

\subsection{Common Trap Poisons}\index{Treasure and Traps!Traps!Common Trap Poisons}

\textbf{Blindness}: The poison blinds the creature if they fail a defense roll. Typical durations are one minute, ten minutes, and one hour. 

\textbf{Choking}: The poison makes the creature choke and cough if they fail a defense roll. Typical durations are one minute, ten minutes, and one hour. Severe versions of choking poison might make a creature start to suffocate. 

\textbf{Damage Track}: The poison moves the creature down one step on the damage track if they fail a defense roll. 

\textbf{Debilitating}: The poison hinders all of the creature’s actions by one or two steps if they fail a defense roll. (Some poisons may affect only certain kinds of actions, such as Speed defense rolls or Might-based tasks.) Typical durations are ten minutes, one hour, and ten hours. 

\textbf{Instant Damage}: The poison inflicts damage (Might, Speed, or Intellect) one time if the creature fails a defense roll. 

\textbf{Ongoing Damage}: The poison inflicts damage (Might, Speed, or Intellect) immediately. When a certain amount of time has passed (such as every round or every minute), it inflicts damage again if the creature fails its defense roll. The ongoing damage usually ends on its own (such as after five additional rounds of damage) or after the creature makes a defense roll against it. Usually the ongoing damage is a much smaller amount than the initial damage, such as 1 point every round. 

\textbf{Paralysis}: The poison prevents the creature from taking any physical actions if they fail a defense roll (this might leave them standing in place like a statue, or make them go limp and collapse to the floor). Typical durations are ten minutes, one hour, and ten hours. 

\textbf{Sleep}: The poison knocks the creature unconscious if they fail a defense roll. Typical durations are ten minutes, one hour, and ten hours. The poison might also make the creature groggy, hindering all actions for an additional amount of time equal to how long the unconsciousness would have lasted (for example, knocking out a creature for an hour and then making them groggy for an hour, even if they’re awakened early).

\subsection{List of Traps}

\subsubsection{Arrow 4 (12)}\index{Treasure and Traps!Traps!Arrow}
...
\textbf{Modifications}: Defense and stealth as level 6 (if hidden behind a hole in the wall) 

\textbf{GM Intrusion}: The arrow is barbed, and removing it inflicts 3 points of damage. The arrow is attached to a string, cord, or wire, with the other end tied to something dangerous like a falling block or an electrical shock.

\subsubsection{Crushing Wall 6 (18)}\index{Treasure and Traps!Traps!Crushing Wall}
...
\textbf{Damage Inflicted}: 6 points (ignores Armor) 

\textbf{GM Intrusion}: The fallen wall blocks access to an exit. The wall debris buries the character, who is trapped until they can dig free. Another trap, hazard, or threat is behind the fallen wall (such as arrow traps or a room full of zombies) and can now reach the characters.

\subsubsection{Disintegration 7 (21)}\index{Treasure and Traps!Traps!Disintegration}
...
\textbf{GM Intrusion}: In addition to inflicting damage, the ray moves the character one step down the damage track. Part of the ray splits or ricochets off the character and strikes a second creature, inflicting 10 points of damage. 

\subsubsection{Explosive Glyph 4 (12)}\index{Treasure and Traps!Traps!Explosive Glyph}
...
\textbf{Damage Inflicted}: 4 points of energy damage (ignores Armor); all creatures in the area take 1 point of damage even if they make their defense roll. 

\textbf{Modifications}: Stealth as level 5 

\textbf{GM Intrusion}: The glyph marks the character’s face with a symbol indicating they are a thief. The glyph makes the character run away in fear for one minute. The character is cursed, and all of their actions are hindered until the curse is removed.

\subsubsection{Flooding Room 4 (12)}\index{Treasure and Traps!Traps!Flooding Room}
...
\textbf{Damage Inflicted}: None until drowning starts 

\textbf{Modifications}: Defends as level 7 

\textbf{GM Intrusion}: Hostile creatures such as piranhas or electric eels are in the water and attack all creatures. The room fills with water faster than expected because the floor and/or ceiling are also moving toward each other.

\subsubsection{Mangler 3 (9)}\index{Treasure and Traps!Traps!Mangler}
...
\textbf{Damage Inflicted}: 3 points, plus lasting damage 

\textbf{Modifications}: Stealth as level 4 

\textbf{GM Intrusion}: The trap has hooks, holding the character in place and inflicting damage when they try to escape if they fail a Speed defense roll. The glue attracts a swarm of fire ants or wasps. The glue is also a slow-acting acid or poison.

\subsubsection{Net 3 (9)}\index{Treasure and Traps!Traps!Net}
...
\textbf{Damage Inflicted}: Entanglement (trapped character cannot move until they use an action to make a Might or Speed defense roll to break or escape the net) 

\textbf{Modifications}: Attacks as level 5, defends as level 2 

\textbf{GM Intrusion}: The net is barbed, inflicting 1 point of damage each round that the trapped character tries to move. The net is the nesting place for biting insects, which swarm and attack the trapped character and all nearby creatures each round.

\subsubsection{Pit 4 (12)}\index{Treasure and Traps!Traps!Pit}
...
\textbf{Damage Inflicted}: 1 point of ambient damage per 10 feet fallen (ignores Armor) 

\textbf{GM Intrusion}: The trapdoor is slippery with oil, hindering attempts to catch the edge and avoid falling. The trapdoor closes after the character falls through, trapping them inside in the darkness. The walls of the pit are greased, hindering attempts to climb out by two steps. A dangerous creature is at the bottom of the pit (or in a room adjacent to it). The pit is filled with poison gas. The trapdoor detaches and falls into the pit, inflicting 1 point of ambient damage per 10 feet it falls. The pit has spikes at the bottom, inflicting an additional 4 points of damage to anyone who falls in.

\subsubsection{Poison Gas 3 (9)}\index{Treasure and Traps!Traps!Poison Gas}
...
\textbf{Damage Inflicted}: As poison 

\textbf{Modifications}: Stealth as level 5 

\textbf{GM Intrusion}: The character has an allergic reaction to the gas, which hinders all their actions for an hour after exposure because of sneezing, watery eyes, or itchy skin. The gas makes the character hallucinate, mistaking their companions for enemies, until they make an Intellect defense roll. The gas is flammable.

\subsubsection{Poision Needle 5 (15)}\index{Treasure and Traps!Traps!Posion Needle}
...
\textbf{Damage Inflicted}: 1 point (plus poison)

\textbf{Modifications}: Stealth as level 6 

\textbf{GM Intrusion}: The trap releases acid into the lock mechanism, making the trapped object impossible to unlock. The trap releases acid into the container, destroying some of the valuables inside. The trap releases a puff of poison gas instead of a poisoned needle, affecting all nearby characters.

\subsubsection{Portcullis 5 (15)}\index{Treasure and Traps!Traps!Portcullis}
...
\textbf{GM Intrusion}: The boulder crashes through a door or wall, giving other dangerous creatures access to the character’s location. The boulder blocks the way out. The boulder carries a character along with it for some distance. The boulder is hollow and full of burning oil, leaving a fiery trail behind it. The boulder is hollow and contains undead skeletons, which jump out as it moves and attack nearby creatures.

\subsubsection{Slicing Blade 5 (15)}\index{Treasure and Traps!Traps!Slicing Blade}
...
\textbf{Modifications}: Attacks as level 6 

\textbf{GM Intrusion}: The blade is a magical weapon with an additional effect, such as inflicting 3 points of fire damage. The blade is rusted and breaks off when it hits the character, inflicting 1 point of damage (ignores Armor) each round after the initial attack until it is healed.

\subsubsection{Sliding Stair 4 (12)}\index{Treasure and Traps!Traps!Sliding Stair}
...
\textbf{Damage Inflicted}: 1 point of ambient damage per 20 feet slid (ignores Armor) 

\textbf{GM Intrusion}: The trap releases oil, hindering attempts to climb the ramp or stairs by two steps. Tiny blades stick out between the sections of the ramp, inflicting an additional 3 points of damage. The trap releases a boulder to roll down the stairs after the sliding character, inflicting an additional 3 points of damage.

\subsubsection{Snake Pit 4 (12)}\index{Treasure and Traps!Traps!Snake Pit}
...
\textbf{Damage Inflicted}: As per the swarm of snakes 

\textbf{GM Intrusion}: The snake poison is especially potent, moving the character one step down the damage track if they fail a Might defense roll. The snakes constrict the character, hindering their actions until the snakes are defeated.

\subsubsection{Spear 4 (12)}\index{Treasure and Traps!Traps!Spear}
...
\textbf{Modifications}: Defense and stealth as level 5 (if hidden behind a hole in a wall) 

\textbf{GM Intrusion}: The impact of the spear knocks the character prone. The spear is barbed, and removing it inflicts 3 points of damage. The spear is attached to a string, cord, or wire, with the other end tied to something dangerous like a falling block or an electrical shock

\subsubsection{Teleporter 6 (18)}\index{Treasure and Traps!Traps!Teleporter}
...
\textbf{Damage Inflicted}: None 

\textbf{GM Intrusion}: The teleport destination is above the ground, causing the character to fall some distance and take damage (1 point of ambient damage per 10 feet fallen). The destination is dangerous, such as a tiny room lined with spikes, a shark tank, or a boulder in a lava lake.
