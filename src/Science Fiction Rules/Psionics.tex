...
\chapter{Optiona Rule: Psionics}\index{Science Fiction Rules!Psionics}
...
\section{Psions and the Optional Latent Psionics Rule}
...
\section{More Powerful Psionics}
