...
\chapter{Vehicles and Spacecraft}\index{Science Fiction Rules!Vehicles and Spacecraft}
...
\section{Contemporary Styling in Advanced or Fantastic Settings}
 
...
\section{Priceless Price Category}
...
\section{Loooking for more Vehicle Options}
...
\section{Planetary Vehicle Listing}\index{Science Fiction Rules!Vehicles and Spacecraft!Planetary Vehicle Listing}

\subsection{Cycles} 

\subsubsection{Contemporary}
 
\textbf{Motorcycle, dirt bike}
 
level 2 (6) 
...
\centering
\caption{Wheeled Vehucle GM Intusion}
\label{lab:Wheeled Vehucle GM Intusion}


\begin{tabularx}{\textwidth}{| p{1cm} | Y |}
\hline
\textbf{1d10} & \textbf{Intrusion} \\ \hline
1 & Vehicle runs out of fuel or power. \\ \hline
2 & Unexpected obstacle threatens to cause a crash. \\ \hline
3 & Unexpected gap or loss of power requires rider to “jump” between stable surfaces by launching off a suitable ramp-like incline. \\ \hline
4 & Another vehicle swerves into PC’s vehicle \\ \hline
5 & Loose sand/gravel/particles/ice on surface threaten to cause a wipeout. \\ \hline
6 & Too much velocity going around a corner threatens to cause a wipeout or crash. \\ \hline
7 & Vehicle takes damage and threatens to detonate its power source. \\ \hline
8 & Another vehicle hits PC’s vehicle from behind. \\ \hline
9 & Vehicle’s brakes freezes. \\ \hline
10 & Vehicle’s tire unexpectedly blows out. \\ \hline
\end{tabularx}
\end{table}
...
\centering
\caption{Hovering and Flying Vehicle GM Intrusion}
\label{lab:Hovering and Flying Vehicle GM Intrusion}


\begin{tabularx}{\textwidth}{| p{1cm} | Y |}
\hline
\textbf{1d10} & \textbf{Intrusion} \\ \hline
1 & Vehicle runs out of fuel or power (but not inflight). \\ \hline
2 & Extreme turbulence threatens to cause a loss of control inflight\\ \hline
3 & A glitch in the flight control—or pilot error—causes vehicle to bank too sharply, threatening a crash. \\ \hline
4 & Unexpected debris/birds or other flying creatures impact the vehicle, damaging it.  \\ \hline
5 & Landing gear is damaged, making eventual landing problematic. \\ \hline
6 & Unexpectedly tall terrain feature threatens imminent collision. \\ \hline
7 & Vehicle takes damage and threatens to detonate its power source. \\ \hline
8 & Another flying vehicle hits PC’s vehicle from above. \\ \hline
9 & Vehicle runs out of fuel or power while inflight. \\ \hline
10 & Breach in airframe risks sucking pilot or passengers out to a long fall. \\ \hline
\end{tabularx}
\end{table}
...
\centering
\caption{Seacraft GM Intrusion}
\label{lab:Seacraft GM Intrusion}

\begin{tabularx}{\textwidth}{| p{1cm} | Y |}
\hline
\textbf{1d10} & \textbf{Intrusion} \\ \hline
1 & Vehicle begins taking on water due to minor leak. \\ \hline
2 & Vehicle capsizes \\ \hline
3 & Vehicle begins to sink due to major leak caused by structural flaw. \\ \hline
4 & Vehicle collides with marine life/debris on water or other watercraft impacts the vehicle, damaging it. \\ \hline
5 & Power source unexpectedly dies. \\ \hline
6 & Unmapped underwater terrain feature threatens/causes imminent collision. \\ \hline
7 & Vehicle takes damage and threatens to detonate its power source. \\ \hline
8 & Sea storm blows up and threatens to capsize vehicle. \\ \hline
9 & Character(s) fall overboard. \\ \hline
10 & Pirates! (Or at least people with bad intentions pull up on another boat.) \\ \hline
\end{tabularx}
\end{table}
...
\textbf{Gunboat, fast attack craft}
...
\textbf{Submarine, supercavitation}
...
\section{Spacecraft Listing}\index{Science Fiction Rules!Vehicles and Spacecraft!Spacecraft Listing}
...
\centering
\caption{Spacecraft GM Intrusion}
\label{lab:Spacecraft GM Intrusion}

\begin{tabularx}{\textwidth}{| p{1cm} | Y |}
\hline
\textbf{1d10} & \textbf{Intrusion} \\ \hline
1 & Spacecraft is holed by micrometeorite or other debris and begins to leak air \\ \hline
2 & Spacecraft power source unexpectedly stutters, runs out of fuel, or malfunctions in a way that could lead to detonation. \\ \hline 
3 & Spacecraft is holed by something large enough to risk a catastrophic blow-out. \\ \hline 
4 & Environmental controls malfunction; ship interior grows colder and colder (causing a buildup of frost and ice on interior surfaces), until the problem can be identified and repaired. \\ \hline 
5 & Drive system surges, causing the vehicle to move faster, farther, or to a different location than was intended. \\ \hline 
6 & Solar flare, gravitational gradient, or other understood but unexpected phenomena damages ship. \\ \hline 
7 & A malfunction, deliberate sabotage by a rival, or a fatal malware-infected shipmind affects the environmental controls in a space suit or entire ship, deoxygenating it until it’s mostly carbon dioxide. Affected characters, initially unaware of the problem, become more and more sleepy until they pass out. \\ \hline 
8 & Gamma ray burst from “nearby” neutron star conjunction threatens to fry ship and everyone on board. \\ \hline 
9 & External operations lead to a character being bucked off craft into empty space. \\ \hline 
10 & Environmental systems are compromised, requiring extensive overhaul to return to normal. \\ \hline 
\end{tabularx}
\end{table}

\begin{multicols}{2}

\subsection{Spacecraft Upkeep}
...
\centering
\caption{Spacecraft Upkeep}
\label{lab:Spacecraft Upkeep}

\begin{tabularx}{\textwidth}{| p{1cm} | Y |}
\hline
\textbf{Level} & \textbf{Upkeept Cost} \\ \hline
1-2 & Moderate \\ \hline
3-5 & Expensive \\ \hline
6-7 & Very Expensive \\ \hline
8-9 & Exorbitant \\ \hline
10 & Priceless \\ \hline 
...
\centering
\caption{Solar System Travel Times}
\label{lab:Solar System Travel Times}

\begin{tabularx}{\textwidth}{| Y | Y | Y |}
\hline
\textbf{Origin} & \textbf{Destination} & \textbf{Travel Time– Nuclear Plasma} \\ \hline
Venus & Merkury & 20 + 1d10 days \\ \hline
Earth/Moon & Venus & 20 + 1d20 days \\ \hline
Earth/Moon & Mars & 20 +1d20 days \\ \hline
Mars & Asteroid Belt & 30 + 1d20 days \\ \hline
Asteroid Belt & Jupiter and its moons & 30 + 1d20 days \\ \hline
Jupiter & Saturn and its moons & 60 + 1d20 days \\ \hline
Saturn & Uranus & 90 + 1d20 days \\ \hline
Uranus & Naptune & 100 + 1d20 days \\ \hline
Naptune & Pluto & 100 + 1d20 days \\ \hline
...
\subsection{Retrofitting Power and Devices}
...
\subsection{Pioner-Era Spacecraft}
...
\textbf{Rocket, heavy-lift launch} 
...
\subsection{Torpedos in Space Combat}
...
\textbf{Microcapsule, fighter (dart)} 
...
\textbf{Spacecraft, dragonfly class} 
...
\textbf{Spacecraft, exploration class} 
...
\textbf{Spacecraft, corvette class} 
...
\textbf{Spacecraft, destroyer class} 
...
\textbf{Starship, cargo/passenger} 
...
\textbf{Starship, general purpose} 
...
\textbf{Starship, discovery class}
...
\subsection{Space-time Vehicles}
...
\textbf{Car, temporal/dimensional} 
...
\subsection{Gate Ring}
\index[CnA]{Artifacts by genre!Science Fiction!Gate Ring}
\index[CnA]{Artifacts by name!Gate Ring}

\textbf{Level}: 1d6 + 4 

\textbf{Form}: Wearable ring of unknown material 

\textbf{Effect}: Creates a full-sized shield that can be used as a regular shield in combat for one character, providing an asset on Speed defense rolls for the duration of that combat, after which it returns to its ring-like form. In addition, the wielder can command the deployed shield to become a functioning star gate that remains open for just one hour, leading to a strange destination (which the wielder is potentially aware of, if they ran sufficient analysis on the ring or otherwise gained information about it before using the function). 

\textbf{Depletion}: Automatic (if gate is formed)

\subsection{Fractal Traveler}
\index[CnA]{Artifacts by genre!Science Fiction!Fractal Traveler}
\index[CnA]{Artifacts by name!Fractal Traveler}

\textbf{Level}: 1d6 + 4 

\textbf{Form}: Goggle-like device of unknown material 

\textbf{Effect}: When worn, induces a powerful hallucinogenic state in wearer. Hallucinations last for four hours, during which time the wearer seems to disappear from existence. From the wearer’s perspective, they are falling through an ever-iterating fractal realm of mind-blowing imagery, possibly some version of hyperspace or dark energy network. At the end of that period they return to existence, either in the same location they left or somewhere they’ve previously visited. The images leave the viewer shaken, but for several hours all Intellect-based tasks are eased. 
...
\hline
\textbf{Starships} & \textbf{Level} & \textbf{Crew} & \textbf{Weapon Systems} \\ \hline
Fighter & 1 & 1 & 1 \\ \hline
Interceptor & 2 & 1 & 1  \\ \hline
Freighter & 3 (4 for defense) & 4 & 1 \\ \hline
Frigate & 4 & 20 & 4  \\ \hline
Cruiser & 4 & 25 & 5  \\ \hline
Battleship & 10 & 1 000 & 36  \\ \hline
\end{tabularx}
\end{table}
