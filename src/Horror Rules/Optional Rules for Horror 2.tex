...
\chapter{Additional Rules for Horror}

\section{General Horror GM Intrusions}
...
\item A mysterious noise nearby amplifies the tension, and when investigated reveals itself to
...
\begin{table}[h]
\centering 
\caption{Horror Mode Escalation Rate}
\label{tab:Horror Mode Escalation Rate}
...
\begin{itemize}
\item A character investigates a strange noise on their own. (“It’ll be fine!”)
