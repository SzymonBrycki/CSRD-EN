...
\chapter{Superpowered Creatures}

\end{multicols}

\begin{table}[h]
\centering
\caption{Superpowered Creatures}
\label{tab:Superpowered Creatures}
\begin{tabularx}{\textwidth}{| p{1cm} | X |}
\hline
Level & Example \\ \hline
9 & Demigod \\ \hline
10 & Kaiju 300 feet (90 m) tall \\ \hline
11 & Robot 1,000 feet (300 m) tall \\ \hline
12 & Vampire blood god \\ \hline
13 & Legendary monster* \\ \hline
14 & Archangel, demon prince, typical god or goddess**, multidimensional sorcerer \\ \hline
15 & Moon-sized space monster, pantheon leader*** \\ \hline
% TUTAJ NASTĄPIŁA KOREKTA (USUNIĘCIE ZEWNĘTRZNYCH '|' w \multicolumn)
 \multicolumn{2}{|p{17cm}|}{* A primordial monster (such as Echidna or Typhon) or a powerful creature associated with the end of the world (such as Jörmungandr or Fenris).} \\ \hline
\multicolumn{2}{|p{17cm}|}{** A powerful, perhaps immortal entity (such as Ares or Loki) that has been worshipped or feared as a god by humans or similar creatures.} \\ \hline
\multicolumn{2}{|p{17cm}|}{*** A god or goddess (such as Odin or Zeus) who is the ruler of a group of deities.} \\ \hline
